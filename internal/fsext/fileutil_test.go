...
func TestGlobWithDoubleStar(t *testing.T) {
	t.Run("finds files matching pattern", func(t *testing.T) {
		...
		matches, truncated, err := GlobGitignoreAwareCtx(context.Background(), "**/main.go", testDir, 0)
	...
	t.Run("finds directories matching pattern", func(t *testing.T) {
		...
		matches, truncated, err := GlobGitignoreAwareCtx(context.Background(), "pkg", testDir, 0)
		require.NoError(t, err)
		require.False(t, truncated)
	...
	t.Run("respects limit parameter", func(t *testing.T) {
		...
		matches, truncated, err := GlobGitignoreAwareCtx(context.Background(), "**/*.txt", testDir, 5)
		require.NoError(t, err)
	...
	t.Run("handles nested directory patterns", func(t *testing.T) {
		...
		matches, truncated, err := GlobGitignoreAwareCtx(context.Background(), "a/b/c/file1.txt", testDir, 0)
		require.NoError(t, err)
		require.False(t, truncated)
	...
	t.Run("returns results sorted by modification time (newest first)", func(t *testing.T) {
		...
		matches, truncated, err := GlobGitignoreAwareCtx(context.Background(), "*.txt", testDir, 0)
		require.NoError(t, err)
		require.False(t, truncated)
	...
	t.Run("handles empty directory", func(t *testing.T) {
		...
		matches, truncated, err := GlobGitignoreAwareCtx(context.Background(), "**", testDir, 0)
		require.NoError(t, err)
		require.False(t, truncated)
	...
	t.Run("handles non-existent search path", func(t *testing.T) {
		...
		matches, truncated, err := GlobGitignoreAwareCtx(context.Background(), "**", nonExistentDir, 0)
	...
	t.Run("respects basic ignore patterns", func(t *testing.T) {
		...
		matches, truncated, err := GlobGitignoreAwareCtx(context.Background(), "*.tmp", testDir, 0)
		require.NoError(t, err)
		require.False(t, truncated)
		require.Empty(t, matches, "Expected no matches for '*.tmp' pattern (should be ignored)")

		matches, truncated, err = GlobGitignoreAwareCtx(context.Background(), "backup", testDir, 0)
		require.NoError(t, err)
		require.False(t, truncated)
	...
	t.Run("handles mixed file and directory matching with sorting", func(t *testing.T) {
		...
		matches, truncated, err := GlobGitignoreAwareCtx(context.Background(), "*.rs", testDir, 0)
		require.NoError(t, err)
		require.False(t, truncated)
